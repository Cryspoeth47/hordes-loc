export default [
...

  {
    ...
    description: {
      ...
      pt: 'Esses braceletes foram criados precipitadamente. As marcas das batalhas brutais dos lados do couro não inspiram confiança sobre a sobrevivência do seu dono anterior.',
...

  {
    ...
    description: {
      ...
      es: 'Cuero resistente que ha sido cuidadosamente transformado a mano en finos brazaletes. Ao lado do couro está a assinatura do artesão: "Markay\'ak".',
      pt: 'Couro resistente qye foi cuidadosamente transformado a mão em finos braceletes. Al costado del cuero está la firma del artesano: "Markay\'ak".',
...

  {
    ...
    description: {
      ...
      vi: 'Những chiếc còng này được rèn bằng một ngọn lửa đặc biệt chỉ có thể được tạo ra thông qua phép thuật. Trong quá khứ, các nguyên tố lửa chỉ dạy cho một vài thợ rèn đặc biệt bí mật để rèn còng này.',
...

  {
    ...
    description: {
      ...
      vi: 'Vòng tay phản chiếu được chế tạo bởi thợ rèn đặc biệt với các kỹ năng cần thiết để chế tạo áo giáp phản chiếu để giảm sát thương. Chất lượng bảo vệ này đã truyền cảm hứng cho nhiều pháp sư Elvish thường thử nghiệm trên các vòng tay được phản chiếu.',
...

  {
    ...
    description: {
      ...
      pt: 'Fragmentos de golem são meticulosamente reunidos por uma pequena equipe de ferreiros que usam magia. Cada par de fragmentos de golem é criado ao longo de várias centenas de dias usando cascas de golens de pedra.',
      ...
      vi: 'Các mảnh của Người đá được lắp ráp một cách tỉ mỉ bởi một nhóm nhỏ thợ rèn sử dụng ma thuật. Mỗi cặp mảnh golem được tạo ra trong vài trăm ngày bằng cách sử dụng vỏ của người đá.',
...

  {
    ...
    description: {
      ...
      pt: 'Braçadeiras como essa são compostas por um metal raro encontrado nas montanhas. Os ferreiros usam martelos encantados para forjar as braçadeiras sem calor, a fim de manter as propriedades de aprimoramento mágico do metal.',
      ...
      vi: 'Những bao tay như thế này bao gồm một kim loại quý hiếm được tìm thấy ở vùng núi. Thợ rèn sử dụng búa mê hoặc để rèn các bao tay mà không cần nhiệt để giữ lại các đặc tính tăng cường ma thuật của kim loại.',
...

  {
    ...
    description: {
      ...
      hu: 'Ezeket a karvédőket fekete meteorkövekből kalapálták ki. Eddig a legnagyobb mennyiségben fekete meteoritot azután a kataklizma után találtak, ami a Második Nagy Háborút követte.',
      ...
      fr: 'Ces brassards ont été créés par des forgerons qui martelaient le métal trouvé dans les météorites noires. Jusqu\'à présent, la plus grande concentration de météorites noires a été trouvée après un cataclysme qui a suivi la Seconde Grande Guerre.',
      ...
      pt: 'Essas braçadeiras foram criadas por ferreiros que martelavam metais encontrados em meteoritos negros. Até agora, a maior concentração de meteoritos negros foi encontrada após um cataclismo que se seguiu à Segunda Grande Guerra.',
...

  {
    ...
    description: {
      ...
      pt: 'Magos ambiciosos à beira da loucura descobriram segredos da magia dimensional e formaram braceletes que transcendem a proteção mágica normal. Esses braceletes anormais exigiam uma forma especial para manter suas propriedades.',
