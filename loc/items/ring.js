export default [
...

  {
    ...
    description: {
      ...
      de: 'Dieser Ring besitzt auf der Innenseite winzige, geschnitzte Runen. Manche Historiker glauben das diese Ringe der letzte Versuch eines verloren Königreiches waren, seine Bevölkerung vor Krankheit zu schützen.',
      vi: 'Chiếc nhẫn này có những cỗ ngữ nhỏ được khắc vào dải bên trong. Một số nhà sử học tin rằng những chiếc nhẫn này là nỗ lực cuối cùng của một vương quốc đã mất để củng cố dân số khỏi bệnh tật.',
...

  {
    ...
    description: {
      ...
      vi: 'Nhẫn Arcane là thí nghiệm ma thuật của các pháp sư. Một số chiếc nhẫn được chế tác và phù phép để tăng cường đáng kể khả năng thi triển phép thuật',
...

  {
    ...
    description: {
      ...
      ru: 'Эти кольца когда-то принадлежали банде "Культ изумрудных пауков", которые одни из первых ездили на пауках.',
      de: 'Diese Ringe gehörten einst dem "Kult der Smaragdspinnen", einer Gruppe von Banditen, die als eine der ersten auf Spinnen ritten.',
      vi: 'Những chiếc nhẫn này từng thuộc về“Cult of the Emerald Spiders”, một nhóm cướp đầu tiên cưỡi nhện.',
...

  {
    ...
    description: {
      ...
      ru: 'Infernal Ring - это подарок от дьявольских существ. Они соблазняют владельца желать больше силы. За этим желанием часто следуют неразумные предложения от большого количества дьяволов.',
      de: 'Höllenringe sind Geschenke von teuflischen Kreaturen. Sie verleiten den Träger, sich mehr Macht zu wünschen. Diesem Wunsch folgen oft Angebote von mehr Teufeln.',
      vi: 'Infernal rings là quà tặng từ các sinh vật quỷ dữ. Họ lôi kéo người mang nó mong muốn quyền lực hơn. Mong muốn này thường được theo sau bởi những lời đề nghị thiếu sáng suốt của nhiều ác quỷ.',
...

  {
    ...
    description: {
      ...
      ru: 'Природные духи изначально дарили эти кольца в знак благодарности первобытным монстрам. Многие из этих колец были украдены или потеряны за тысячи лет.',
      de: 'Naturgeister gaben diese Ringe als Anerkennungsgeschenk an Ur-Monster. Über tausende von Jahren gingen viele dieser Ringe verloren oder wurden gestohlen.',
      vi: 'Nature spirits ban đầu đã tặng những chiếc nhẫn này như một món quà đánh giá cao những con quái vật nguyên thủy. Nhiều chiếc nhẫn trong số này đã bị đánh cắp hoặc mất trong hàng ngàn năm.',
...

  {
    ...
    description: {
      ...
      ru: 'Многие религиозные фракции утверждают, что люди, носящие это кольцо, имеют благосклонность к божеству; однако конкретное божество не известно. Многие религиозные деятели считают, что божественная анонимность носит преднамеренный характер.',
      de: 'Viele religiöse Gruppen behaupten das Personen, die diesen Ring tragen den Segen eines Gottes erhalten. Welcher Gott ist jedoch unbekannt. Viele religiöse Figuren glauben, das diese Anonymität Absicht ist.',
      vi: 'Nhiều phe phái tôn giáo cho rằng các cá nhân đeo chiếc nhẫn này có sự ưu ái của một vị thần; tuy nhiên, vị thần cụ thể không được biết đến. Nhiều nhân vật tôn giáo tin rằng sự ẩn danh của Thiên Chúa là có chủ ý',
...

  {
    ...
    description: {
      ...
      ru: 'Древние свитки утверждают, что эти легендарные кольца делают владельца почти непобедимым. В свитках также упоминаются истории о том, как носители становятся сломлены и глубоко несчастными.',
      de: 'Uralte Schriften behaupten das diese legendären Ringe den Träger fast unverwundbar machen. Die Schriften also berichten von Trägern die korrumpiert und unglücklich wurden.',
      vi: 'Các cuộn giấy cổ xưa cho rằng những chiếc nhẫn huyền thoại này khiến người đeo gần như bất khả chiến bại. Các cuộn sách cũng đề cập đến những câu chuyện về người mặc trở nên tha hóa và vô cùng bất hạnh.',
...

  {
    ...
    description: {
      ...
      ru: 'Один раз за век, находят Peacekeeper и отмечают его носителя как особого защитника царств. В прошлом веке носительница Peacekeeper потерпела неудачу, и началась Third Great War.',
      de: 'Einmal in jedem Zeitalter wird ein Peacekeeper gefunden und markiert den Träger als besonderen Beschützer der Reiche. Im letzten Zeitalter scheiterte der Ringträger und der große dritte Krieg begann.',
      vi: 'Mỗi thời đại, một Peacekeeper  được tìm thấy và đánh dấu người mặc là người bảo vệ đặc biệt của các cõi. Trong một thời đại đã qua, Peacekeeper đã thất bại và Đại chiến thứ ba bắt đầu.',
